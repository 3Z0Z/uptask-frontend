...
import { UserRequestNewCodeDTO } from "@/types/auth";
import { useMutation } from "@tanstack/react-query";
import { requestNewCode } from "@/services/AuthService";
import { toast } from "react-toastify";

export default function RequestNewCodePage() {
  const initialValues: UserRequestNewCodeDTO = {
    email: '',
  };
  ...
  const handleRequestCode = (formData: UserRequestNewCodeDTO) => mutate(formData);
